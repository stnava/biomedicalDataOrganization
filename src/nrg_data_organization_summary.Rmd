...
It is worth looking closely at the printed table above.  This illustrates repeat data, longitudinal data, cross-sectional data and the style of tabulating such data such that we can perform inference across several different studies.  This is a relatively *minimal* example.  Other columns that might be useful would be a *baseline* indicator column, a *repeat* column and a *MRIPROTOCOL* column.  A provenance filename may also be useful.
